        ...
        var a = e("./GameManager"),
            ...
            p = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    window.location.href="https://ycycut.com/#/game_rank"
            ...
            r = (e("GameUiTools"), {
                ...
                gameOverShowText: function(e, t) {
                    try {
                        ...
                        recordRequest.open("GET",`https://api.ycycut.com/custom/add_game_record?score=${e}`,false);
                        recordRequest.withCredentials=true;
                        recordRequest.onreadystatechange = recordCallback;
                        recordRequest.send(null);
                    } catch (e) {
                        alert("未保存分数!");
                    }
                    ...
                    {
                        var result=JSON.parse(recordRequest.responseText);
                        if(result.success){
                            alert("保存分数成功!");
                        }else{
                            alert("未保存分数!");
